...
// normalized_constant
int normalized_constant(NumericVector& norm, const NumericMatrix& degree, const NumericVector& theta, const NumericVector& f, const NumericMatrix& offset_tk);
RcppExport SEXP PAFit_normalized_constant(SEXP normSEXP, SEXP degreeSEXP, SEXP thetaSEXP, SEXP fSEXP, SEXP offset_tkSEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        int __result = normalized_constant(norm, degree, theta, f, offset_tk);
...
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        int __result = get_stats(time_stamp, unique_stamp, in_node, out_node, all_node, ok_node, bin_vector, max_node_id, undirected, only_PA, time_vector, Sum_m_k, n_tk, m_tk, m_t, offset_tk, z_j, node_degree);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
...
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        int __result = update_f(f, non_zero_f, degree, theta, z_j, normalized_const, m_t, shape, rate);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
...
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        NumericVector __result = coeff_theta(degree, f, normalized_const, m_t, length_theta);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
...
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        Rcpp::traits::input_parameter< const int >::type length_theta(length_thetaSEXP );
        NumericVector __result = coeff_var(degree, f, normalized_const, m_t, offset, length_theta);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
...
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        Rcpp::traits::input_parameter< const NumericVector& >::type m_t(m_tSEXP );
        Rcpp::traits::input_parameter< const double >::type shape(shapeSEXP );
        int __result = cal_var_f(cov_f, non_zero_f, degree, theta, f, z_j, normalized_const, m_t, shape);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
