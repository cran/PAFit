...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(normalized_constant(norm, degree, theta, f, offset_tk));
    return __result;
END_RCPP
}
// get_stats
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(get_stats(time_stamp, unique_stamp, in_node, out_node, all_node, ok_node, bin_vector, max_node_id, undirected, only_PA, time_vector, Sum_m_k, n_tk, m_tk, m_t, offset_tk, z_j, node_degree));
    return __result;
END_RCPP
}
// update_f
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(coeff_theta(degree, f, normalized_const, m_t, length_theta));
    return __result;
END_RCPP
}
// coeff_var
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const int >::type length_theta(length_thetaSEXP);
    __result = Rcpp::wrap(coeff_var(degree, f, normalized_const, m_t, offset, length_theta));
    return __result;
END_RCPP
}
// cal_var_f
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const NumericVector& >::type m_t(m_tSEXP);
    Rcpp::traits::input_parameter< const double >::type shape(shapeSEXP);
    __result = Rcpp::wrap(cal_var_f(cov_f, non_zero_f, degree, theta, f, z_j, normalized_const, m_t, shape));
    return __result;
END_RCPP
}
